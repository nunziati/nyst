...
class CustomDataset(Dataset):
    def __init__(self, csv_input_file, csv_label_file, preprocess=None, transform=None):
        ...
        self.data, self.invalid_videos = self.filtering_invalid_data(self.data)
        print(len(self.data))
        print(self.invalid_videos)
        input('Filtering part is completed. Press a key to continue: ')
