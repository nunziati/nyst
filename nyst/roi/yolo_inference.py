...
model = YOLO('/repo/porri/nyst/yolo_models/best_yolo11m.pt')  # Sostituisci con il percorso corretto al tuo file .pt

# Specifica la cartella dei video di input e quella di output
input_folder = "/repo/porri/nyst_labelled_videos/videos"
output_folder = "/repo/porri/nyst_labelled_videos"  # Assicurati che questa cartella esista
